...
website=$(python -c "import os, json;print(json.load(open(os.environ['METADATA']))['KPlugin']['Website'])")
bugAddress="$website"
...
xgettext --from-code=UTF-8 -C -kde -L Javascript -ci18n -ki18n:1 -ki18nc:1c,2 -ki18np:1,2 -ki18ncp:1c,2,3 \
